...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/wamp/www/SymfonyPlatform/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('D:/wamp/www/SymfonyPlatform/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/wamp/www/SymfonyPlatform/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/wamp/www/SymfonyPlatform/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_e43cf97ff7d12318df97d0ae18dd86e89e97e1886001985ead0d998a16a1fc89');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_e43cf97ff7d12318df97d0ae18dd86e89e97e1886001985ead0d998a16a1fc89');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e43cf97ff7d12318df97d0ae18dd86e89e97e1886001985ead0d998a16a1fc89');
        ...
        $d->setProxyDir('D:/wamp/www/SymfonyPlatform/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/wamp/www/SymfonyPlatform/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/wamp/www/SymfonyPlatform/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/wamp/www/SymfonyPlatform/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/wamp/www/SymfonyPlatform/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/wamp/www/SymfonyPlatform/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/wamp/www/SymfonyPlatform/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/wamp/www/SymfonyPlatform/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/wamp/www/SymfonyPlatform/app', 'UTF-8'));
        ...
        $instance->addGlobal('webmaster', 'Romain Fauconnier');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\src\\RMS\\PlatformBundle/Resources/views', 'RMSPlatform');
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/wamp/www/SymfonyPlatform/app/Resources/views');
        $instance->addPath('D:\\wamp\\www\\SymfonyPlatform\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'D:\\wamp\\www\\SymfonyPlatform\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/wamp/www/SymfonyPlatform/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/wamp/www/SymfonyPlatform/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/wamp/www/SymfonyPlatform/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/wamp/www/SymfonyPlatform/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev',
            'kernel.logs_dir' => 'D:/wamp/www/SymfonyPlatform/app/logs',
            'kernel.bundles' => array(
                ...
                'RMSPlatformBundle' => 'RMS\\PlatformBundle\\RMSPlatformBundle',
            ...
            'debug.container.dump' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/wamp/www/SymfonyPlatform/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/wamp/www/SymfonyPlatform/app/../web',
            'assetic.write_to' => 'D:/wamp/www/SymfonyPlatform/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/wamp/www/SymfonyPlatform/app/cache/dev/doctrine/orm/Proxies',
