...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/wamp/www/SymfonyPlatform/app/cache/prod/annotations', false);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_cbfe073cb746846a47a09b7afa33c57c2256517560ef99dc4838126de2a5df46');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_cbfe073cb746846a47a09b7afa33c57c2256517560ef99dc4838126de2a5df46');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_cbfe073cb746846a47a09b7afa33c57c2256517560ef99dc4838126de2a5df46');
        ...
        $d->setProxyDir('D:/wamp/www/SymfonyPlatform/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('D:/wamp/www/SymfonyPlatform/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/wamp/www/SymfonyPlatform/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/wamp/www/SymfonyPlatform/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/wamp/www/SymfonyPlatform/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/wamp/www/SymfonyPlatform/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/wamp/www/SymfonyPlatform/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/wamp/www/SymfonyPlatform/app/cache/prod',
            ...
            'session.save_path' => 'D:/wamp/www/SymfonyPlatform/app/cache/prod/sessions',
            ...
            'router.resource' => 'D:/wamp/www/SymfonyPlatform/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/wamp/www/SymfonyPlatform/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/wamp/www/SymfonyPlatform/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/wamp/www/SymfonyPlatform/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/wamp/www/SymfonyPlatform/app/cache/prod/doctrine/orm/Proxies',
